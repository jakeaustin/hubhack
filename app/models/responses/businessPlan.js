var AppResponses = (function(that){
  ...
  that.HasBusinessPlan.setNextStep(AppSteps.FinancingStep);
  ...
  that.HasNoBusinessPlan.setNextStep(AppSteps.FinancingStep);
  ...
  that.UnknownBusinessPlan.setNextStep(AppSteps.FinancingStep);
